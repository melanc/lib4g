...
func Debug(a ...interface{}) {
	newEntry(printDefault, "DEBUG", "", a...)
}

func Debugf(format string, a ...interface{}) {
	newEntry(printFormat, "DEBUG", format, a...)
}

func Info(a ...interface{}) {
	newEntry(printDefault, "INFO", "", a...)
}

func Infof(format string, a ...interface{}) {
	newEntry(printFormat, "INFO", format, a...)
}

func Warn(a ...interface{}) {
	newEntry(printDefault, "WARN", "", a...)
}

func Warnf(format string, a ...interface{}) {
	newEntry(printFormat, "WARN", format, a...)
}

func Error(a ...interface{}) {
	newEntry(printDefault, "ERROR", "", a...)
}

func Errorf(format string, a ...interface{}) {
	newEntry(printFormat, "ERROR", format, a...)
}

func Fatal(a ...interface{}) {
	newEntry(printDefault, "FATAL", "", a...)
}

func Fatalf(format string, a ...interface{}) {
	newEntry(printFormat, "FATAL", format, a...)
}
